...
export class ServiceError extends Error {
	 ...
	 */
	toString() {
		return `[Error Code: ${this.error.code}] ${this.error.message} ${
			this.contextualMessage ? this.contextualMessage : ''
		}`;
	}
}
...
export class ServiceErrorBuilder {
	 ...
	 */
	withContextualMessage(message: string) {
