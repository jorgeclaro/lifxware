...
import { StateDeviceChainResponse, Tile } from './tiles';
...
function toObject(buf: Buffer) {
	...
	let obj: StateDeviceChainResponse;
...
//eslint-disable-next-line complexity
function toBuffer(obj: StateDeviceChainResponse) {
...
export const stateDeviceChain: PacketBodyHandler = {
	type: 702,
