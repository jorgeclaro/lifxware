...
import { SetTileState64Request } from './tiles';
...
function toBuffer(obj: SetTileState64Request) {
...
export const stateTileState64: PacketBodyHandler = {
	type: 711,
