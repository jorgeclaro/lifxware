 ...
 */
export function validateNormalisedColorInfrared(brightness: number) {
 ...
 */
export function packetToNormalisedInfrared(packetColor: ColorInfrared): ColorInfrared {
 ...
 */
export function normalisedToPacketInfraed(irColor: ColorInfrared): ColorInfrared {
