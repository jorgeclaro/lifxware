import { DimAbsoluteRequest } from './dimmer';
...
function toBuffer(obj: DimAbsoluteRequest) {
...
export const setDimAbsolute: PacketBodyHandler = {
	type: 104,
	name: 'setDimAbsolute',
	legacy: false,
	size: SIZE,
